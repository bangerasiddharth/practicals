...
# Using the default plot() option first
...
# Doesnt tell us much so we can use libraries to help improve 
...
# We could also use the transform command
...
# This does not present much to us as we are comparing numerical and categorical data
attach(beavers_data)
...
# We cannot use the test for dicotomous data
